...
function loadEnvFiles(): void {
  const candidates = [
    ...
    resolve(process.cwd(), "apps/opslens-server/.env.local"),
...
const envSchema = z.object({
  ...
  AI_CACHE_TTL_MS: z.coerce
    ...
    .max(60 * 60 * 1000)
    .default(120000),
  OPS_CACHE_DASHBOARD_SUMMARY_TTL_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(5 * 60 * 1000)
  ...
  OPS_CACHE_DASHBOARD_BRIEFING_TTL_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(10 * 60 * 1000)
  ...
  OPS_CACHE_DEPLOYMENT_IMPACT_TTL_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(5 * 60 * 1000)
  ...
  OPS_CACHE_ISSUE_LIST_TTL_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(5 * 60 * 1000)
  ...
  OPS_CACHE_QA_SCENARIO_TTL_MS: z.coerce
    .number()
    .int()
    .min(1000)
    .max(5 * 60 * 1000)
