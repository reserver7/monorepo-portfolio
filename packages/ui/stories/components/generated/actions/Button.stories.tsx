...
const meta: Meta<typeof Button> = {
  title: "Components/Generated/Actions/Button",
  component: Button,
  tags: ["autodocs"],
  parameters: {
    layout: "padded",
  ...
  argTypes: {
    variant: { control: "select", options: ["primary","secondary","danger","ghost","outline"], table: { defaultValue: { summary: "primary" } } },
    size: { control: "select", options: ["sm","md","lg"], table: { defaultValue: { summary: "md" } } },
    shape: { control: "select", options: ["default","rounded","pill"], table: { defaultValue: { summary: "default" } } },
