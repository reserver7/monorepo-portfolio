...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    variant: {control:"select",options:["primary","secondary","danger","ghost","outline","text","link"],table:{defaultValue:{summary:"primary"}}},
    size: {control:"select",options:["sm","md","lg"],table:{defaultValue:{summary:"md"}}},
    shape: {control:"select",options:["default","rounded","pill","square"],table:{defaultValue:{summary:"default"}}},
    loadingLabel: {control:"text",table:{}},
