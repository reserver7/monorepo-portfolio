...
const meta: Meta<typeof Table> = {
  title: "Components/Generated/Data/Table",
  component: Table,
  tags: ["autodocs"],
  parameters: {
    layout: "padded",
  ...
  argTypes: {
    density: { control: "select", options: ["compact","default","comfortable"], table: { defaultValue: { summary: "default" } } },
    stickyHeader: { control: "boolean", table: { defaultValue: { summary: false } } },
  ...
  render: (args) => (
    <section className="space-y-3 rounded-xl border border-default bg-surface p-4">
      ...
      <div className="grid items-start gap-2 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <div className="rounded-md border border-default bg-surface p-3">
            <div className="text-caption text-muted mb-2">stickyHeader=true</div>
            <Table
              {...sanitizeStoryArgs(args as Record<string, unknown>)}
