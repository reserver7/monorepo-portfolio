...
const meta: Meta<typeof Typography> = {
  title: "Components/Generated/Data/Typography",
  ...
  argTypes: {
    ...
    tone: { control: "select", options: ["default","muted","subtle","primary","success","warning","danger","info"], table: { defaultValue: { summary: "default" } } },
