    ...
    <section className="border-default bg-surface space-y-3 rounded-[var(--radius-xl)] border p-4">
      ...
      <div className="grid items-start gap-2 sm:grid-cols-2 xl:grid-cols-3">
        <div className="border-default bg-surface rounded-[var(--radius-md)] border p-3">
          ...
          <Avatar {...sanitizeStoryArgs(args as Record<string, unknown>)} />
        </div>
        <div className="border-default bg-surface rounded-[var(--radius-md)] border p-3">
          <div className="text-caption text-muted mb-2">bordered</div>
          <Avatar {...sanitizeStoryArgs(args as Record<string, unknown>)} bordered />
        </div>
        <div className="border-default bg-surface rounded-[var(--radius-md)] border p-3">
          <div className="text-caption text-muted mb-2">showStatus</div>
          <Avatar {...sanitizeStoryArgs(args as Record<string, unknown>)} showStatus />
        </div>
      </div>
    </section>
  )
