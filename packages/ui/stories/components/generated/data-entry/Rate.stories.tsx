...
const meta: Meta<typeof Rate> = {
  ...
  argTypes: {
    allowHalf: { control: "boolean", table: { defaultValue: { summary: true } } },
    allowClear: { control: "boolean", table: { defaultValue: { summary: true } } },
    count: { control: { type: "number" }, table: { defaultValue: { summary: 5 } } },
...
export const Playground: Story = {
  render: (args) => <Rate {...sanitizeStoryArgs(args as Record<string, unknown>)} />
};
