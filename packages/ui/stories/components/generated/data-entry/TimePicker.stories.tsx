...
const meta: Meta<typeof TimePicker> = {
  ...
  argTypes: {
    variant: {
      control: "select",
      options: ["outlined", "filled", "borderless", "underlined", "default", "outline", "ghost"],
      table: {}
    },
    status: {
      control: "select",
      options: ["error", "warning", "success", "validating", "default"],
      table: {}
    },
    format: {
      control: "select",
      options: ["HH:mm", "HH:mm:ss", "h:mm A", "h:mm:ss A"],
...
export const Playground: Story = {
  render: (args) => <TimePicker {...sanitizeStoryArgs(args as Record<string, unknown>)} />
};
