...
export const Playground: Story = {
  render: (args) => (
    <Flex {...sanitizeStoryArgs(args as Record<string, unknown>)}>
      <div className="border-default bg-surface-elevated text-body-sm rounded-[var(--radius-md)] border px-3 py-1.5">
        Item A
      </div>
      <div className="border-default bg-surface-elevated text-body-sm rounded-[var(--radius-md)] border px-3 py-1.5">
        Item B
