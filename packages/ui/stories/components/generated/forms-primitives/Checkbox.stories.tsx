...
const meta: Meta<typeof Checkbox> = {
  title: "Components/Generated/Forms Primitives/Checkbox",
  component: Checkbox,
  tags: ["autodocs"],
  parameters: {
    layout: "padded",
  ...
  argTypes: {
    ...
    label: { control: "text", table: { defaultValue: { summary: "약관에 동의합니다" } } },
  ...
  render: (args) => (
    <section className="space-y-3 rounded-xl border border-default bg-surface p-4">
      ...
      <div className="grid items-start gap-2 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <div className="rounded-md border border-default bg-surface p-3">
            <div className="text-caption text-muted mb-2">중간 상태</div>
            <Checkbox
              {...sanitizeStoryArgs(args as Record<string, unknown>)}
