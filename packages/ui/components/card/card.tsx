...
export const Card = React.memo(function Card({
  ...
  return (
    <div
      className={cn(resolveCardRootClassName({ variant, interactive, padding, radius, bordered }), className)}
      {...props}
    />
  );
});
...
export const CardHeader = React.memo(function CardHeader({
  ...
  return (
    <div
      className={cn("flex flex-col space-y-1.5", CARD_SECTION_PADDING_CLASS[padding], className)}
      {...props}
    />
  );
});
...
export const CardFooter = React.memo(function CardFooter({
  ...
  return (
    <div className={cn("flex items-center", CARD_SECTION_PADDING_CLASS[padding], className)} {...props} />
  );
});
